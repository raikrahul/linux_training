...
# PROBE 0 AXIOMS: HARDWARE TO lock_vma_under_rcu

## 1. HARDWARE ORIGIN AXIOM (The Root)
...
## 2. CALL STACK TRACE (Axiom: Hardware to VMA)
...
## 3. PSEUDO-DEBUGGER TRACE: lock_vma_under_rcu
...
## 4. SEARCH AXIOM: THE FIRST FINDER
